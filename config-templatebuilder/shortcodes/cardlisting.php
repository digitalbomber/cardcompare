...
if ( !class_exists( 'avia_sc_cardlisting' ) )
{
	class avia_sc_cardlisting extends aviaShortcodeTemplate
	{
			/**
			...
			function popup_elements()
			{
				$this->elements = array(
					...
					*/
					...
					array(
                        "name" 	=> __("Card Listing Image Size", 'avia_framework' ),
                        "desc" 	=> __("Set the image size of the Card Listing images", 'avia_framework' ),
                        "id" 	=> "preview_mode",
                        "type" 	=> "select",
                        "std" 	=> "auto",
                        "subtype" => array(__('Set the Card Listing image size automatically based on column or layout width','avia_framework' ) =>'auto',__('Choose the Card Listing image size manually (select thumbnail size)','avia_framework' ) =>'custom')),

                    array(
                        "name" 	=> __("Select custom image size", 'avia_framework' ),
                        "desc" 	=> __("Choose image size for Card Listing Images", 'avia_framework' ) . "<br/><small>" . __("(Note: Images will be scaled to fit for the amount of columns chosen above)", 'avia_framework' )."</small>",
                        "id" 	=> "image_size",
                        "type" 	=> "select",
