...
if ( !class_exists( 'avia_sc_promoboxhome' ) )
{
	class avia_sc_promoboxhome extends aviaShortcodeTemplate
	{
			/**
			...
			function popup_elements()
			{
				$this->elements = array(
					...
					array(
							"name" 	=> __("Content",'avia_framework' ),
							"desc" 	=> __("Enter some content for Promo Box Home",'avia_framework' ),
							"id" 	=> "content",
							"type" 	=> "tiny_mce",
							"std" 	=> __("Put your credit card text here", "avia_framework" )),
					
					array(	"name" 	=> __("Image URL", 'avia_framework' ),
							"desc" 	=> __("This is the image URL", 'avia_framework' ),
				            "id" 	=> "imgurl",
				            "type" 	=> "input",
				            "std" => "http://"),
			...
			function editor_element($params)
			{
				...
				$params['innerHtml'] .= "		<div class='cc-promoimage'><img src='".$params['imgurl']."' alt=''  /></div>";
				$params['innerHtml'] .= "		<div data-update_with='content' class='cc-promocontent-home'>".stripslashes(wpautop(trim($params['content'])))."</div>";
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				$output.= "	<div {$style} class='cc-promobox-home ".$this->class_by_arguments('button' , $atts, true).$meta['el_class']."'>";
				$output .= "<div class='flex_column av_two_third  flex_column_div av-zero-column-padding first  avia-builder-el-0  el_before_av_one_third  avia-builder-el-first '>";
				$output.= "		<div class='cc-promoimage'><img src='".$imgurl."' alt='' /></div>";
				$output.= "		<div class='cc-promocontent-home'>".stripslashes(wpautop(trim($content)))."</div>";
				$output.= "	</div>";
				$output.= "<div class='flex_column av_one_third  flex_column_div av-zero-column-padding   avia-builder-el-2  el_after_av_two_third  el_before_cc_promobox-popular cc-promocontent-home_btn_wrapper' id='cc-promocontent-home_btn_wrapper'>"; 
